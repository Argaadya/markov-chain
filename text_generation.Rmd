...
Create the predictive function and see what is the next word if we insert `I wish` .
...
[^7]: [Text Generation With LSTM Recurrent Neural Networks in Python with Keras](https://machinelearningmastery.com/text-generation-lstm-recurrent-neural-networks-python-keras/)
[^8]: [Markov Chains: How to Train Text Generation to Write Like George R. R. Martin](https://www.kdnuggets.com/2019/11/markov-chains-train-text-generation.html)
[^9]: [How Neural Networks Are Learning to Write](https://towardsdatascience.com/how-neural-networks-are-learning-to-write-d631b249b499?gi=348999a0611a)
[^10]: [Markov Chains Explained Visually](https://setosa.io/ev/markov-chains/)
[^11]: [Introduction to Operation Research](https://www.amazon.com/Introduction-Operations-Research-Hillier-Lieberman/dp/0071139893)
[^12]: [Multiple Decrement Models in Insurance](https://www.springer.com/gp/book/9788132206583)
